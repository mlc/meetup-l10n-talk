...
set timefmt x "%m/%d/%y"
set xdata time
set timefmt cb "%m/%d/%y"
set timefmt y2 "%m/%d/%y"
set y2data 
set timefmt x2 "%m/%d/%y"
set x2data 
set boxwidth
...
set xtics "07/06/15",1.2096e+06 norangelimit
...
set title "Registrations per Week" 
...
set xrange [ "07/06/15" : "10/05/15" ] noreverse nowriteback
...
GNUTERM = "wxt"
plot "iejp.csv" using 1:3 title "Japan" with lines, '' using 1:2 with lines title "Ireland"
#    EOF
