...
\begin{frame}%
\note{registrations on Android among users in Japan went up a little bit when we launched translation beg of Sept but only shot up when we launched platformwide and made a real effort the end of the month, as a control: Ireland are flat/growing slowly}%
\input{iejp.tex}%
\end{frame}
